      ...
      this.weather.getForecast(this.city).subscribe((data: any) => {
        ...
        for (let i = 0; i < data.length; i++) {
          ...
          if (((date === todayNumberInWeek + 1) || (todayNumberInWeek === 6 && date === 0)) && !this.day1Name) {
            this.day1Name = days[data];
            this.day1Sate = data[i].weather[0].main;
            ...
            this.day2Sate = data[i].weather[0].main;
            ...
            this.day3Sate = data[i].weather[0].main;
            ...
            this.day4Sate = data[i].weather[0].main;
            ...
            this.day5Sate = data[i].weather[0].main;
